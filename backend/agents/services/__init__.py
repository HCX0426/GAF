...
# Device service
# Agent token services (from the original agents/services.py → agent_service.py)
from agents.agent_service import (
    create_agent_token,
...
from agents.services.device_service import (
    DeviceService,
