...
dormant_n_count: 15
# next_n_id: 下一个可用的 N 编号 (spec §6.2 P1-8 新增; AI 写新 lesson 时原子递增 + 文件锁; 2026-08-28 校准: N209-N216 均已分配, 新 lesson 从 N217 起; 2026-08-29: N217/N218/N219 已分配; 2026-08-30: N220 已分配)
next_n_id: 221
---
...
- `cross-layer-sync_2026-08-30_n220-batch-naming-normalization-line-ending-artifact.md` — 批量命名归一化方法论 (5 层 sweep + 词边界正则) + 行尾符伪影判定 (git status M 但 diff 空) ⭐ **N220**
